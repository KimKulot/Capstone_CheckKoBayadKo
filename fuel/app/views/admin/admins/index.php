    ...
    <section>
        <div class="section-header">
            <ol class="breadcrumb"> 
                ...
                <?php echo Html::anchor('admin/admins/index', 'College Education', array('class' => 'btn btn-sm btn-primary pull-right ink-reaction')); ?>
                </ol>
						...
						<tr>
							...
							<?php $total = $paid + $unpaid + $partial; ?>
								<?php if($total != 0){ ?>
									...
									<td> <?php echo Html::anchor('admin/admins/view_basic/'.$program->basic_program_description, 'Students Financial Assessment', array('class' => 'btn ink-reaction btn-primary btn-raised btn-sm')); ?> </td>
