            ...
            <div class="card">
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<?php foreach ($progheads as $deans): ?>
							<?php foreach ($users as $user): ?>
								<?php if ($deans->user_id == $user->id): ?>
									...
									<!-- <?php foreach ($programs as $program): ?>
										...
										<?php endif ?>
									<?php endforeach ?> -->
									<td> <?php echo Html::anchor('admin/deans/view_proghead_student/'.$user->id, 'View', array('class' => 'btn ink-reaction btn-primary btn-raised btn-sm')); ?>
									</tr>
								<?php endif; ?>
							<?php endforeach ?>
						<?php endforeach ?>
