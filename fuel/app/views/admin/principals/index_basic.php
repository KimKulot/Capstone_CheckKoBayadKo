						...
						<tr>
							...
							<?php $total = $paid + $unpaid + $partial; ?>
								<?php if($total != 0){ ?>
									...
									<td> <?php echo Html::anchor('admin/principals/index_student/'.$program->basic_program_description, 'Students Financial Assessment', array('class' => 'btn ink-reaction btn-primary btn-raised btn-sm')); ?> </td>
