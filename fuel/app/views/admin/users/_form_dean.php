	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('', 'role', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('role', Input::post('role', isset($user) ? $user->role : '1'), array('class' => 'col-md-4 form-control', 'placeholder'=>'Group', 'type'=>'hidden')); ?>

		</div>

		<div class="form-group">
		    <?php echo Form::label('Program', 'program_id', array('class'=>'control-label')); ?>
		 	<?php 
			 	echo Form::select('program_id', Input::post('program_id', isset($student) ? $user->program_id : ''), array(
				    'College' => array( 
				        '1' => 'BSIT',
				        '2' => 'BSBA',
				        '3' => 'BSCS',
